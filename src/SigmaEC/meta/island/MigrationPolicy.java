 ...
 * @author Eric O. Scott
 */
public abstract class MigrationPolicy<T extends Individual<F>, F extends Fitness> extends ContractObject {
     ...
     */
    public abstract void migrateAll(final int generation, final Population<T, F> population, final Topology topology);
     ...
     */
    public abstract void migrateAll(final int generation, final Population<T, F> population, final Topology topology, final Option<List<IslandConfiguration>> islands);
}
