...
"	\\node[buffer gate, point down,draw=none] (node0) at (0,0) {\\rotatebox{90}{$I_{0}$}};\n" +
"	\\node[buffer gate, point down,draw=none] (node1) at (2,0) {\\rotatebox{90}{$I_{1}$}};\n" +
"	\\node[nand gate,inputs={nn}, point down] (node2) at (0,-2) {};\n" +
"		\\draw (node0.output) -- ++(down:5mm) -| (node2.input 1);\n" +
"		\\draw (node1.output) -- ++(down:5mm) -| (node2.input 2);\n" +
"	\\node[nand gate,inputs={nn}, point down] (node3) at (2,-2) {};\n" +
"		\\draw (node1.output) -- ++(down:5mm) -| (node3.input 1);\n" +
"		\\draw (node0.output) -- ++(down:5mm) -| (node3.input 2);\n" +
"	\\node[xor gate,inputs={nn}, point down] (node4) at (0,-4) {};\n" +
"		\\draw (node2.output) -- ++(down:5mm) -| (node4.input 1);\n" +
"		\\draw (node3.output) -- ++(down:5mm) -| (node4.input 2);\n" +
"	\\node[nand gate,inputs={nn}, point down] (node5) at (2,-4) {};\n" +
"		\\draw (node3.output) -- ++(down:5mm) -| (node5.input 1);\n" +
"		\\draw (node3.output) -- ++(down:5mm) -| (node5.input 2);\n" +
"	\\node[buffer gate, point down,draw=none] (out0) at (0,-6) {\\rotatebox{90}{$O_{0}$}};\n" +
"		\\draw (node4.output) -- ++(down:5mm) -| (out0);\n" +
"	\\node[buffer gate, point down,draw=none] (out1) at (2,-6) {\\rotatebox{90}{$O_{1}$}};\n" +
